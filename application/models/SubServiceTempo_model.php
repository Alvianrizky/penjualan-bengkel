...
class SubServiceTempo_model extends MY_Model
{
	protected $column_order = array(null, 'SubServiceID','ItemID','Jumlah', 'Total'); 
    protected $column_search = array('SubServiceID','ItemID.NamaItem', 'ItemID.HargaJual','Jumlah', 'Total');
    protected $order = array('SubServiceID' => 'asc');

	public function __construct()
	{
        $this->table = 'subservice_t';
	...
	private function _get_datatables_query()
    {
        ...
        $this->db->join('item', 'item.ItemID=subservice_t.ItemID');
