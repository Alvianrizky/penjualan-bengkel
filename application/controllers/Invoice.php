...
class Invoice extends CI_Controller {
   ...
   public function __construct()
   {
	  ...
	  $this->load->model(array('Invoice_model' => 'penjualan', 'Subtransaksi_model' => 'subtransaksi', 'Products_model' => 'produk'));
	...
	{  
      ...
      $this->templatekasir->backend('invoice_v', $data);
	}
	...
	public function get_invoice()
	{
		...
		$penjualan = $this->penjualan->filter();
