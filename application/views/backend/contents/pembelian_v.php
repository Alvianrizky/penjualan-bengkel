					...
					<div class="box-body">
						<div class="row">
							<div class="col-3" style="padding: 20px;">
								...
								<table>
									<tr>
										<th style="width: 100px!important;">PembelianID</th>
										<td style="width: 20px!important;">:</td>
										<td style="width: 200px!important;"><div id="PembelianID"></div></td>
									</tr>
									<tr>
										<th>Tanggal</th>
										<td>:</td>
							...
							<div class="col-lg-12 table-responsive">
								<div id='subpembelian' style="margin: 0 100px;"></div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function view_data(id) {
		$.post(site_url + 'view/', {
			...
			$('#PembelianID').html(data.PembelianID);
			$('#created_at').html(data.created_at);
			$('#subpembelian').html(data.subpembelian);
