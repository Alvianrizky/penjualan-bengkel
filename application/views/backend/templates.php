...
<body class="hold-transition skin-blue sidebar-mini" onkeydown="myFunction()">
    <div class="wrapper">
        ...
        <div class="content-wrapper scroll1" style="max-height: 500px; height: auto;">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019-2020 <a href="http://almsaeedstudio.com">Ducati Motor</a>.</strong> All rights reserved.
        </footer>
